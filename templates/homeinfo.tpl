...
<div class="homeinfo-container">
    <div class="flex-d row align-items-stretch">
        ...
        <div class="homeinfo-inner col-sm-6 col-md-4" style="">
            <div class="grid-item">
                <div class="grid-top" style="background-image: url('theme/solent/images/cards/example.png');"></div>
                <div class="grid-bottom">
        ...
        <div class="homeinfo-inner col-sm-6 col-md-4">
            <div class="grid-item">
                <div class="grid-top" style="background-image: url('theme/solent/images/cards/groups.png');"></div>
                <div class="grid-bottom">
        ...
        <div class="homeinfo-inner col-sm-6 col-md-4">			
            <div class="grid-item">
                <div class="grid-top" style="background-image: url('theme/solent/images/cards/secret.png');"></div>
                <div class="grid-bottom">
